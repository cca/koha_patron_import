...
fac_depts: dict[str, str | int | None] = {
    ...
    "Fine Arts": 3,
    "Fine Arts Division": 3,
    "First Year": 10,
    "First Year Core Studios": 10,
    "Furniture": 2,
    "Furniture Design": 2,
    "Game Arts": 3,
    "Glass": 3,
    ...
    "Grad Design": 2,
    "Graduate Design": 2,
    "Graduate Design Strategy": 2,
    "Graduate Film": 3,
    "Graduate Fine Arts": 3,
    "Graduate Interaction Design": 2,
    "Graduate Visual and Critical Studies": 6,
    "Graduate Writing": 7,
    "Graphic Design": 2,  # -> Comm Design (2025)
    ...
    "Textiles": 3,
    "Upper Division Interdisciplinary Studio": "b",
